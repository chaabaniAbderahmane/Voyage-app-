    ...
    if not buses:
        ...
        if mode == "Formulaire (un par un)":
            ...
            bulk_text = st.text_area("Liste des voyageurs", height=200,
                                      help="Vous pouvez aussi utiliser la dictée vocale du clavier de votre téléphone/ordinateur : "
                                           "appuyez sur le micro de votre clavier et parlez, le texte s'écrit ici tout seul.")
